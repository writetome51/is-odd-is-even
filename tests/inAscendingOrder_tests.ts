...
// Test 1
if (inAscendingOrder([1, -5, 10, 11])) console.log('test 1 failed');
else console.log('test 1 passed');

// Test 2
if (inAscendingOrder([-10, 5, 10, -11])) console.log('test 2 failed');
else console.log('test 2 passed');

// Test 3
if (inAscendingOrder([1, 5, 10, 11])) console.log('test 3 passed');
else console.log('test 3 failed');

// Test 4
if (inAscendingOrder([-20, -5, 10, 11])) console.log('test 4 passed');
else console.log('test 4 failed');

// Test 5
if (inAscendingOrder([-20.2, -5.4, 10.2, 11])) console.log('test 5 passed');
else console.log('test 5 failed');

// Test 6
if (inAscendingOrder([-1.023, -1.021, 0.222, 0.223])) console.log('test 6 passed');
else console.log('test 6 failed');

// Test 7
if (inAscendingOrder([-1.023, -1.024, 0.222, 0.223])) console.log('test 7 failed');
